    ...
    <div className="min-h-screen bg-[#faf9f7]">
      ...
      <main>
        <section className="max-w-4xl mx-auto px-4 pt-16 pb-12">
          {/* H1 with keyword */}
          <h1 className="sr-only">Sommelier AI - Your Personal AI Wine Expert</h1>
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-lg text-stone-500 max-w-xl mx-auto mb-10 leading-relaxed">
              Sommelier AI listens to what you want and recommends the perfect wine for any occasion.
        ...
        <section id="how-sommelier-ai-works" className="bg-white py-24">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-lg text-stone-500 text-center max-w-2xl mx-auto mb-16">
              Sommelier AI uses advanced artificial intelligence to provide personalized wine recommendations through natural voice conversation.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              <div className="text-center">
                ...
                <h3 className="font-bold text-stone-900 text-xl mb-3">Start Sommelier AI</h3>
                <p className="text-stone-500 leading-relaxed">Tap the play button to begin a voice conversation with Sommelier AI, your personal AI wine expert.</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="font-bold text-stone-900 text-xl mb-3">Tell Sommelier AI what you need</h3>
                <p className="text-stone-500 leading-relaxed">Describe the occasion, your taste preferences, budget, or what food you are eating to Sommelier AI.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-stone-500 leading-relaxed">Sommelier AI suggests specific wines with tasting notes, prices, and food pairing suggestions.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-[#faf9f7]">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-lg text-stone-500 text-center max-w-2xl mx-auto mb-8">
              Sommelier AI is an artificial intelligence wine advisor that provides expert-level wine recommendations through natural voice conversation. Sommelier AI is like having a professional sommelier in your pocket, available 24 hours a day, 7 days a week.
            </p>
            <p className="text-lg text-stone-500 text-center max-w-2xl mx-auto mb-16">
              Whether you are looking for wine recommendations for a dinner party, trying to find the perfect wine pairing for steak, or want to learn about wine regions like Bordeaux or Napa Valley, Sommelier AI can help. Our AI sommelier technology makes expert wine advice accessible to everyone, completely free.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <article className="bg-white rounded-xl p-6 border border-stone-100">
                ...
                <p className="text-stone-500">Sommelier AI knows red wine, white wine, rosé, and sparkling wines from every major wine region. Get personalized wine recommendations matched to your taste preferences.</p>
              </article>
              <article className="bg-white rounded-xl p-6 border border-stone-100">
                <img
                ...
                <p className="text-stone-500">Tell Sommelier AI what you are eating and get the perfect wine match. Sommelier AI understands food and wine pairing principles from classic combinations to creative pairings.</p>
              </article>
              <article className="bg-white rounded-xl p-6 border border-stone-100">
                <img
                  src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext y='.9em' font-size='90'%3E💰%3C/text%3E%3C/svg%3E"
                  alt="Sommelier AI budget wine recommendations icon"
                  width="48"
                  height="48"
                  className="w-12 h-12 mb-4"
                />
                <h3 className="font-bold text-stone-900 text-lg mb-2">Sommelier AI for Any Budget</h3>
                <p className="text-stone-500">Sommelier AI recommends wines at every price point. From everyday bottles under $15 to special occasion splurges, Sommelier AI finds great wines within your budget.</p>
              </article>
              <article className="bg-white rounded-xl p-6 border border-stone-100">
                <img
                  src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext y='.9em' font-size='90'%3E🌍%3C/text%3E%3C/svg%3E"
                  alt="Sommelier AI wine regions knowledge icon"
                  width="48"
                  height="48"
                  className="w-12 h-12 mb-4"
                />
                <h3 className="font-bold text-stone-900 text-lg mb-2">Sommelier AI Wine Education</h3>
                <p className="text-stone-500">Sommelier AI teaches you about wine regions including Bordeaux, Burgundy, Napa Valley, Tuscany, and Marlborough. Learn about grape varieties, tasting notes, and wine terminology.</p>
              </article>
            </div>
          </div>
        </section>
        ...
        <section id="sommelier-ai-for-business" className="py-24 bg-stone-900 text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-lg text-stone-300 max-w-xl mx-auto mb-6">
              Restaurants, wine retailers, and hospitality businesses can integrate Sommelier AI into their customer experience. Help your guests find the perfect wine with Sommelier AI technology.
            </p>
            <p className="text-lg text-stone-300 max-w-xl mx-auto mb-10">
              Sommelier AI offers enterprise solutions including API access, custom integrations, and white-label Sommelier AI products. Contact us to learn how Sommelier AI can enhance your business.
            </p>
            ...
            >
              Contact Sommelier AI for Enterprise
            </a>
            ...
            <div className="space-y-4">
              <details className="bg-white rounded-xl border border-stone-100 group">
                <summary className="px-6 py-4 cursor-pointer font-medium text-stone-900 flex justify-between items-center">
                  Is Sommelier AI free to use?
                  <span className="text-stone-400 group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="px-6 pb-4 text-stone-500">Yes, Sommelier AI is completely free to use. Start using Sommelier AI immediately by tapping the play button above. Sign in to save your preferences and get even more personalized Sommelier AI recommendations over time.</p>
              </details>
              <details className="bg-white rounded-xl border border-stone-100 group">
                <summary className="px-6 py-4 cursor-pointer font-medium text-stone-900 flex justify-between items-center">
                  How accurate is Sommelier AI?
                  <span className="text-stone-400 group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="px-6 pb-4 text-stone-500">Sommelier AI is trained on professional sommelier knowledge covering thousands of wines from wine regions worldwide. Sommelier AI recommendations consider your taste preferences, budget, occasion, and food pairings to provide relevant, expert-level wine suggestions.</p>
              </details>
              <details className="bg-white rounded-xl border border-stone-100 group">
                <summary className="px-6 py-4 cursor-pointer font-medium text-stone-900 flex justify-between items-center">
                  What is Sommelier AI?
                ...
                <p className="px-6 pb-4 text-stone-500">Sommelier AI is an artificial intelligence sommelier that uses advanced AI technology to provide personalized wine recommendations through natural voice conversation. Sommelier AI acts like having a professional sommelier available on demand, helping you discover wines you will love.</p>
              </details>
              <details className="bg-white rounded-xl border border-stone-100 group">
                <summary className="px-6 py-4 cursor-pointer font-medium text-stone-900 flex justify-between items-center">
                  Can businesses integrate Sommelier AI?
                  <span className="text-stone-400 group-open:rotate-180 transition-transform">▼</span>
                </summary>
                <p className="px-6 pb-4 text-stone-500">Absolutely. Sommelier AI offers enterprise solutions for restaurants, wine retailers, and hospitality businesses. Contact Sommelier AI for API access, custom integrations, and white-label Sommelier AI products tailored to your business needs.</p>
              </details>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-white border-t border-stone-100 py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-center text-stone-400 text-xs mt-8">
            © {new Date().getFullYear()} Sommelier AI. All rights reserved. Drink responsibly.
          </p>
        </div>
      </footer>
    </div>
